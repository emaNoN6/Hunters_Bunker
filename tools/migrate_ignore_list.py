...
if __name__ == "__main__":
	...
	db_manager_functions = {
		'get_all_sources', 'log_acquisition', 'dunno'
	}
	for func in db_manager_functions:
		if not hasattr(db_manager, func) and inspect.isfunction(func):
			print(f"[MIGRATE_IGNORE] Error: This script requires {func} in db_manager.py to run.")
			exit()
	migrate_ignores()
